...
<section class="container pb-5 pt-4">
  ...
  <div class="carousel-inner">
    ...
    <a href="#"><img src="<?php echo get_template_directory_uri();?>/img/slider/slider1.png" class="d-block w-100" alt="..."></a>
    </div>
    <div class="carousel-item" data-bs-interval="2000">
	<a href="#"><img src="<?php echo get_template_directory_uri();?>/img/slider/slider2.png" class="d-block w-100" alt="..."></a>s
    </div>
  </div>
...
<?php echo do_shortcode( '[products popularity column=4 limi=4]' ); ?>
...
<div class="categories__col col-md-4 col-sm-12 mb-3">
<a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
  <img class="position-absolute top-0 bottom-0 end-0 start-0" src="<?php echo get_template_directory_uri();?>/img/categories/care.png" alt="..." loading="lazy">
...
<div class="categories__col col-md-4 col-sm-12 mb-3">
<a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
  <img class="position-absolute top-0 bottom-0 end-0 start-0" src="<?php echo get_template_directory_uri();?>/img/categories/accessories.png" alt="..." loading="lazy">
...
<div class="pt-5 pb-5"></div>
<?php echo do_shortcode( '[sale_products column=4 limi=4]' ); ?>
